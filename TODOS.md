...
- [x] **OCR ảnh check-in bằng Antigravity Gemini**: Day1 + Day2 + Day3 (33 ảnh) + Day4 (15 ảnh) đã được OCR chính xác bằng Gemini Vision (`view_file`), kết quả lưu trong `discord-export/ocr-results.json`.
